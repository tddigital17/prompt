import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, inject, getCurrentScope, toRef, isRef, defineComponent, ref, h, createApp, provide, shallowReactive, isVNode, createCommentVNode, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, mergeProps, Suspense, Fragment, shallowRef, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { f as createError$1, p as parseURL, e as encodePath, l as decodePath, m as hasProtocol, n as isScriptProtocol, o as joinURL, w as withQuery, q as sanitizeStatusCode, r as getContext, $ as $fetch, v as createHooks, x as executeAsync, y as getHeader, z as setCookie, A as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CFNpp94D.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: { "middleware": "auth" },
    component: () => import('./index-Dg0BBxFZ.mjs')
  },
  {
    name: "admin-login",
    path: "/admin/login",
    component: () => import('./login-INj0RfZD.mjs')
  },
  {
    name: "detail-id",
    path: "/detail/:id()",
    component: () => import('./_id_-DBZlYUnG.mjs')
  },
  {
    name: "admin-prompts",
    path: "/admin/prompts",
    meta: { "middleware": "auth" },
    component: () => import('./prompts-CaLhszBa.mjs')
  },
  {
    name: "admin-settings",
    path: "/admin/settings",
    meta: { "middleware": "auth" },
    component: () => import('./settings-CrCcXFD6.mjs')
  },
  {
    name: "admin-categories",
    path: "/admin/categories",
    meta: { "middleware": "auth" },
    component: () => import('./categories-DINaGKPU.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DiBlxM67.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-nla4jKIu.mjs'));
...
export { _export_sfc as _, useRoute as a, useNuxtApp as b, asyncDataDefaults as c, createError as d, entry_default as default, useRouter as e, encodeRoutePath as f, useRuntimeConfig as g, nuxtLinkDefaults as h, defineNuxtRouteMiddleware as i, navigateTo as n, resolveRouteObject as r, sanitizeTag as s, tryUseNuxtApp as t, useSupabaseUser as u };
