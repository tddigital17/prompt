...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li></ul></div><div class="p-3 border-top border-secondary border-opacity-25 bg-black bg-opacity-25" data-v-c21f74fc><div class="d-flex align-items-center justify-content-between" data-v-c21f74fc><div class="d-flex align-items-center overflow-hidden me-2" data-v-c21f74fc><div class="avatar bg-primary-subtle text-primary rounded-circle p-2 me-2 d-flex align-items-center justify-content-center fw-bold" style="${ssrRenderStyle({ "width": "38px", "height": "38px" })}" data-v-c21f74fc><i class="bi bi-person-fill fs-5" data-v-c21f74fc></i></div><div class="text-truncate" data-v-c21f74fc><div class="fw-bold text-white small text-truncate" data-v-c21f74fc>${ssrInterpolate(((_a = unref(user)) == null ? void 0 : _a.email) || "Administrator")}</div><span class="badge bg-success bg-opacity-25 text-success border border-success border-opacity-25 py-0 px-2" style="${ssrRenderStyle({ "font-size": "0.65rem" })}" data-v-c21f74fc>Super Admin</span></div></div><button class="btn btn-outline-danger btn-sm border-0 rounded-circle p-2 ms-1" title="Logout" data-v-c21f74fc><i class="bi bi-power fs-5" data-v-c21f74fc></i></button></div></div></aside></div>`);
    };
  }
};
...
//# sourceMappingURL=AdminSidebar-HCNEtzig.mjs.map
