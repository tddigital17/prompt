import { _ as __nuxt_component_0 } from './AdminSidebar-HCNEtzig.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-BlqZ6m_D.mjs';
import { ref, withAsyncContext, computed, mergeProps, unref, withCtx, createVNode, createTextVNode, watch, useSSRContext } from 'vue';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(recentPrompts), (p) => {
        var _a;
        _push(`<tr data-v-8aef6dd0><td class="px-4 py-3" data-v-8aef6dd0><div class="fw-bold text-dark text-truncate" style="${ssrRenderStyle({ "max-width": "260px" })}" data-v-8aef6dd0>${ssrInterpolate(p.title)}</div></td><td class="px-3 py-3" data-v-8aef6dd0><span class="badge bg-primary-subtle text-primary border border-primary border-opacity-25 rounded-pill px-2.5 py-1" data-v-8aef6dd0>${ssrInterpolate(((_a = p.categories) == null ? void 0 : _a.name) || "Umum")}</span></td><td class="px-3 py-3 text-muted small" data-v-8aef6dd0>${ssrInterpolate(unref(formatDate)(p.created_at))}</td></tr>`);
      });
      _push(`<!--]-->`);
...
//# sourceMappingURL=index-Dg0BBxFZ.mjs.map
