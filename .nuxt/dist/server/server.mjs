import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, provide, h, ref, isVNode, createCommentVNode, Suspense, Fragment, mergeProps, useSSRContext, defineAsyncComponent, unref, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "D:/1. Data/8.Projek/GitHub/prompt/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "D:/1. Data/8.Projek/GitHub/prompt/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/1. Data/8.Projek/GitHub/prompt/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, setCookie, getHeader } from "D:/1. Data/8.Projek/GitHub/prompt/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { defu } from "D:/1. Data/8.Projek/GitHub/prompt/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "D:/1. Data/8.Projek/GitHub/prompt/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CFNpp94D.js")
  },
  {
    name: "admin",
    path: "/admin",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-Dg0BBxFZ.js")
  },
  {
    name: "admin-login",
    path: "/admin/login",
    component: () => import("./_nuxt/login-INj0RfZD.js")
  },
  {
    name: "detail-id",
    path: "/detail/:id()",
    component: () => import("./_nuxt/_id_-DBZlYUnG.js")
  },
  {
    name: "admin-prompts",
    path: "/admin/prompts",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/prompts-CaLhszBa.js")
  },
  {
    name: "admin-settings",
    path: "/admin/settings",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/settings-CrCcXFD6.js")
  },
  {
    name: "admin-categories",
    path: "/admin/categories",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/categories-DINaGKPU.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-Cem9d95a.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DiBlxM67.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-nla4jKIu.js"));
